...
Typed argocd resources for the Cloudcoil Kubernetes client.

[![PyPI](https://img.shields.io/pypi/v/cloudcoil.models.argocd.svg)](https://pypi.org/project/cloudcoil.models.argocd/)
...
```sh
uv add cloudcoil.models.argocd
# Or:
pip install cloudcoil.models.argocd
```
